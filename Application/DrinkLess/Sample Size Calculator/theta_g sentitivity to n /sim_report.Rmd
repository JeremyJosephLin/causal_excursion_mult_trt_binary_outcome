...
```{r}
# only run this chunk to read new results from HPC
n_seed = 1
...
# 1. Make plots for n versus ATE------------------------------------------------
    n_ATE <- readRDS(here("dataset", "n_vs_gt.RDS"))
    ...
    annotate("text", x = 0, y = n_constant_spnc + 1, 
             label = paste0("constant MEE(t): n = ", n_constant_spnc), size = 10) +
    ...
    ggsave("size Drinkless n vs gt_shape.jpg", height = 8, width = 8)
    ggsave("size Drinkless n vs gt_shape.pdf", height = 8, width = 8)
```
