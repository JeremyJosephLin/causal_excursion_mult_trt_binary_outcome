...
```{r}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/typeI_error_simulation/1. all working assumptions hold/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/typeI_error_simulation//1. all working assumptions hold/factorial_design.RDS")
n_seed = 21
nsim = 1000
...
typeierror_3 <- 
    ...
    scale_x_continuous(breaks = c(20, 250, 500, 750, 1000)) +
    theme_bw() + myggfont()
...
png("figure 0 - typeirror.png", width = 1000, height = 500)
grid.arrange(typeierror_1, typeierror_2, typeierror_3, ncol = 3)
#grid.arrange(typeierror_1, typeierror_2,  ncol = 2)
dev.off()
```