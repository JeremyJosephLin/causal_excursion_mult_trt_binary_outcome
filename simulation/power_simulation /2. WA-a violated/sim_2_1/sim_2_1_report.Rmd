...
```{r}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_1/sim_2_1a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_1/sim_2_1a/factorial_design.RDS")
n_seed = 6
nsim = 1000

result_list = list()
for (isim in 1:n_seed) {
  fileName = paste("results_sim_2_1_setting_",isim,"_",nsim,".RDS",sep = "")
...
ggsave(paste0("viol1_sim1_power_v2.jpg"), width = 12, height = 6)
