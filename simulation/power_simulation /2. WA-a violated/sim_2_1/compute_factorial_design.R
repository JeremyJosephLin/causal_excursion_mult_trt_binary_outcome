...
mean(SD$error_indicator)
# get rid of SD that has error
SD<- SD[which(SD$error_indicator ==0),]
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_1/sim_2_1a/factorial_design.RDS")
