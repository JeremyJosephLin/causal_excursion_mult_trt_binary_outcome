rm(list = ls(all = TRUE))
# call functions
#setwd("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_1/sim_2_1a/")
...
outName <- paste("results_sim_2_1_setting_",isetting,"_",nsim,".RDS",sep = "")
