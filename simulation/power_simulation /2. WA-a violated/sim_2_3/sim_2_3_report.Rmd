...
```{r eval=FALSE}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_3/sim_2_3a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_3/sim_2_3a/factorial_design.RDS")
n_seed = 6 
nsim = 1000
...
ggsave(paste0("viol1_sim3_v2 - power.jpg"), width = 12, height = 6)
```
