...
```{r eval=FALSE}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_5/sim_2_5a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_5/sim_2_5a/factorial_design.RDS")
n_seed = 6
nsim = 1000

result_list = list()
for (isim in 1:n_seed) {
  fileName = paste("results_sim_2_5_setting_",isim,"_",nsim,".RDS",sep = "")
...
ggsave(paste0("figure 3_v2 - power.jpg"), width = 12, height = 6)
```

```{r}
result$gt_shape_and_gt_t_theta %>% unique
```
