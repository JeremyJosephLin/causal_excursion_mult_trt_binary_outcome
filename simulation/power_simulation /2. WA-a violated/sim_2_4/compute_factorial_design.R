...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  ft_w_shape = NA,
                  ft_w_theta = NA,
                  ft_w_theta2 = seq(from = -1, to = 1, by = 0.02),
                  gt_w_shape = NA,
                  gt_w_theta = NA,
                  beta1_w0 = NA,
                  beta1_w1 = NA,
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_4/sim_2_4a/factorial_design.RDS")
