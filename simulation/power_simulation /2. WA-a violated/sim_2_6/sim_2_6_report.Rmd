...
```{r}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_6/sim_2_6a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /2. WA-a violated/sim_2_6/sim_2_6a/factorial_design.RDS")
n_seed = 6 
nsim = 1000
truth_hypothesis = "H1"
dim(SD)
...
ggsave(paste0("figure 2.6_v2 - power.jpg"), width = 12, height = 6)
```
