...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /6.WA-e violated/sim_7_1a/factorial_design.RDS")
