rm(list = ls(all = TRUE))
# call functions
#setwd("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /6.WA-e violated/sim_7_2a/")
...
outName <- paste("results_sim_7_2_setting_",isetting,"_",nsim,".RDS",sep = "")
