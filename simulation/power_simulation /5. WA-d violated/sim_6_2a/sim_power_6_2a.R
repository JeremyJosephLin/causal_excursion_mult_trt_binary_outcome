rm(list = ls(all = TRUE))
# call functions
#setwd("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /5. WA-d violated/sim_6_2a/")
...
outName <- paste("results_sim_6_2_setting_",isetting,"_",nsim,".RDS",sep = "")
