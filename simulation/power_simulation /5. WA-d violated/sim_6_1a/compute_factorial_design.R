# This code generalize the simulation for sim_5_1 misppecification of availability pattern 
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /5. WA-d violated/sim_6_1a/factorial_design.RDS")
