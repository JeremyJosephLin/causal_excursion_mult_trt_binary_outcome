...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /5. WA-d violated/sim_6_3a/factorial_design.RDS")
