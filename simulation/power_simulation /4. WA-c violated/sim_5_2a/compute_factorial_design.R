# This code generalize the simulation for sim_5_2 misppecification of availability pattern 
# true availability pattern is constant, working availability pattern is linear and periodical
rm(list = ls())
