...
```{r}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /4. WA-c violated/sim_5_3a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /4. WA-c violated/sim_5_3a/factorial_design.RDS")
n_seed = 27
nsim = 1000
truth_hypothesis = "H1"
dim(SD)
...
for (isim in 1:n_seed) {
  fileName = paste("results_sim_5_3_setting_",isim,"_",nsim,".RDS",sep = "")
...
ggsave(paste0("figure 5_3 - power.pdf"), width = 18, height = 6)
ggsave(paste0("figure 5_3 - power.jpg"), width = 18, height = 6)
```
