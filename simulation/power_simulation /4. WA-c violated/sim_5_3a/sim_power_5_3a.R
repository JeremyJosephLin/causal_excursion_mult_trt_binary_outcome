rm(list = ls(all = TRUE))
# call functions
#setwd("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /4. WA-c violated/sim_5_3a/")
...
outName <- paste("results_sim_5_3_setting_",isetting,"_",nsim,".RDS",sep = "")
