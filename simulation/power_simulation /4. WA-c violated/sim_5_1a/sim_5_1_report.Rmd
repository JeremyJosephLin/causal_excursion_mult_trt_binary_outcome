...
```{r}
source("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /4. WA-c violated/sim_5_1a/utillity.R")
# read simulation design 
SD <- readRDS("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /4. WA-c violated/sim_5_1a/factorial_design.RDS")
n_seed = 36 
nsim = 1000
truth_hypothesis = "H1"
dim(SD)
...
for (isim in 1:n_seed) {
  fileName = paste("results_sim_5_1_setting_",isim,"_",nsim,".RDS",sep = "")
...
# 3. Make plots and tables ------------------------------------------------
    ...
    result$ATE_t_and_ASPNC_t <- paste0(result$ratio_ATE, " ", result$ft_t_theta, " ",result$ft_t_shape) # note this variable name is confusing this shouldve been ate and ft_theta
...
ggsave(paste0("figure 5_1 - power.pdf"), width = 10, height = 6)
ggsave(paste0("figure 5_1 - power.jpg"), width = 10, height = 6)
