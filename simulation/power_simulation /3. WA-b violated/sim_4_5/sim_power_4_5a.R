rm(list = ls(all = TRUE))
# call functions
#setwd("~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /3. WA-b violated/sim_4_5/sim_4_5a/")
...
outName <- paste("results_sim_4_5_setting_",isetting,"_",nsim,".RDS",sep = "")
