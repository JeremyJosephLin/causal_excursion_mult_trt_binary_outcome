# This code generalize the simulation for sim_4_5 constant gt^* and quadratic gt^w
...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  gt_w_theta = seq(from = -0.5, to = 0.5, by = 0.01),
                  beta1_w0 = NA,
                  beta1_w1 = NA,
                  beta1_w2 = NA,
                  beta2_w0 = NA,
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /3. WA-b violated/sim_4_5/sim_4_5a/factorial_design.RDS")
