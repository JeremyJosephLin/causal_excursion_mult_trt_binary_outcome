# This code generalize the simulation for sim_4_2 linear gt^* and constant gt^w
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /3. WA-b violated/sim_4_2/sim_4_2a/factorial_design.RDS")
