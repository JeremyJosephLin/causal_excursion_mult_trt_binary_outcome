# This code generalize the simulation for sim_4_4 constant gt^* and linear gt^w
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /3. WA-b violated/sim_4_4/sim_4_4a/factorial_design.RDS")
