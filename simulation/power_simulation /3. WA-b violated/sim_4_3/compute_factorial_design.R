# This code generalize the simulation for sim_4_3 quadratic gt^* and constant gt^w
...
SD <- expand.grid(gamma = 0.05,  # type I error
                  ...
                  gt_t_theta = seq(from = -.5, to = .5, by = 0.01), 
...
saveRDS(SD, file = "~/Documents/Research/causal-excursion-multi-treatment-binary-outcome/simulations/power_simulation /3. WA-b violated/sim_4_3/sim_4_3a/factorial_design.RDS")
